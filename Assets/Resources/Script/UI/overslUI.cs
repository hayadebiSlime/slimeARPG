...
public class overslUI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            for (int l = 0; l == 0 && GManager.instance.Pstatus[i].getpl > 0 && GManager.instance.Pstatus[i].hp < 1;)
            {
                boxnumber += 1;
                l++;
            }
    ...
    public void ItemSet()
    {
        ...
        GManager.instance.ItemID[37].itemnumber -= 1;
        GManager.instance.Pstatus[onSlime[selectnumber]].hp = GManager.instance.Pstatus[onSlime[selectnumber]].maxHP;
        GManager.instance.Pstatus[onSlime[selectnumber]].mp = GManager.instance.Pstatus[onSlime[selectnumber]].maxMP;
        //----------------------------------------------
        SetUI();
